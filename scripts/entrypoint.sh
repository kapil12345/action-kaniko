...
#
# If the extra imae tags are enabled
#	* Branch name
#	* Special
#
##################################################
...
then
	...
	export CACHE_ENABLED="${CACHE_ENABLED:+--cache}"
...
# NOTE: From Kaniko v1.0.0 requires '--force' to run outside a container

KANIKO_VERSION=$(/kaniko/executor version)

writeLog "INFO" "Running ${KANIKO_VERSION:-unknown} with the following arguments: --force ${ARGS:-unknown}"
